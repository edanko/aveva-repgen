...
namespace ReportsGenerator
{
	internal sealed class NestList
	{
		...
		public static object NestlistGen(BackgroundWorker bw, List<string> files)
		{
			...
			var application =
				(Microsoft.Office.Interop.Excel.Application) Activator.CreateInstance(Type.GetTypeFromCLSID(clsid));
			...
			{
				workbook.SaveAs(
					$"{MySettingsProperty.Settings.WorkDir}\\{MySettingsProperty.Settings.Draw} - Ведомость карт раскроя.xls", Missing.Value, Missing.Value, Missing.Value, Missing.Value,
					...
					}, null))))
				{
					...
					}, null)), "PP") > 0)
					{
						if (flag)
						{
							...
							array[1, Conversions.ToInteger(obj)] = (
								NewLateBinding.LateIndexGet(myArray[num20], new object[]
								{
									11
								}, null));
							array[2, Conversions.ToInteger(obj)] = (
								NewLateBinding.LateIndexGet(myArray[num20], new object[]
								{
									24
								}, null));
					...
					}, null)), "RBAR") > 0)
					{
						if (flag2)
						{
							...
							array2[1, Conversions.ToInteger(obj2)] = (
								NewLateBinding.LateIndexGet(myArray[num20], new object[]
								{
									11
								}, null));
							array2[2, Conversions.ToInteger(obj2)] = (
								NewLateBinding.LateIndexGet(myArray[num20], new object[]
								{
									24
								}, null));
					...
					}, null)), "TUBE") > 0)
					{
						if (flag3)
						{
							...
							array3[1, Conversions.ToInteger(obj3)] = (
								NewLateBinding.LateIndexGet(myArray[num20], new object[]
								{
									11
								}, null));
							array3[2, Conversions.ToInteger(obj3)] = (
								NewLateBinding.LateIndexGet(myArray[num20], new object[]
								{
									24
								}, null));
