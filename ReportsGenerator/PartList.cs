    ...
    public static ArrayList PartlistGen(BackgroundWorker bw, string wcogFile, string partlistFile, string docFile)
    {
        ...
        checked
        {
            ...
            foreach (var line in wcogLines)
            {
                ...
                {
                    if (string.IsNullOrEmpty(elems[0])) Interaction.MsgBox("Пустая строка! Сейчас будет ошибка!");
            ...
            foreach (var line in partlistLines)
            {
                ...
                if (!Information.IsNothing(elems) & (j != 0))
                {
                    ...
                    if (Information.UBound(elems) < 26)
                    {
                        ...
                        for (j = num5; j >= num6; j += -1) text2Copy += ",";
                    }
            ...
            for (j = 2; j <= num - 1; j++)
            {
                ...
                while (!flag2)
                {
                    if ((Conversions.ToInteger(NewLateBinding.LateIndexGet(arrayList[j], new object[]
                        ...
                        {
                            0
                        }, null))) & (Strings.InStr(Conversions.ToString(NewLateBinding.LateIndexGet(arrayList2[l],
                            new object[]
                            {
                                8
                            }, null)), "used") == 0))
                    {
                        ...
                        if (Conversions.ToBoolean(Operators.AndObject(Operators.CompareObjectEqual(
                                NewLateBinding.LateIndexGet(arrayList[j], new object[]
                                {
                                    18
                                }, null), "", false), Operators.CompareObjectNotEqual(NewLateBinding.LateIndexGet(
                                arrayList2[l], new object[]
                                {
                                    13
                                }, null), "", false))))
                            NewLateBinding.LateIndexSetComplex(arrayList[j], new[]
                        ...
                        {
                            var value = (int) Math.Round(Math.Round(double.Parse(NewLateBinding.LateIndexGet(
                                arrayList2[l], new object[]
                                {
                                    16
                    ...
                    l++;
                    if (l > arrayList2.Count - 1) flag2 = true;
                }
            }
            ...
            for (var m = 1; m <= num20; m++)
            {
                ...
                for (l = num21; l <= num22; l++)
                    if (Conversions.ToBoolean(Operators.AndObject(Operators.CompareObjectEqual(
                            ...
                            {
                                0
                            }, null), false), Operators.CompareObjectEqual(NewLateBinding.LateIndexGet(arrayList4[l],
                            new object[]
                            {
                                18
                            }, null), NewLateBinding.LateIndexGet(arrayList[m], new object[]
            ...
            var workbook = application.Workbooks.Open(
                $"{System.Windows.Forms.Application.StartupPath}\\perech_det_shabl22220.xls", Missing.Value,
            ...
            worksheet.get_Range("L5", Missing.Value).set_Value(Missing.Value, NewLateBinding.LateIndexGet(arrayList4[1],
                new object[]
                {
                    1
                }, null));
            ...
            {
                l = j + 6;
                worksheet.get_Range($"B{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        0,
                        j
                    }, null));
                worksheet.get_Range($"C{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        1,
                        j
                    }, null));
                worksheet.get_Range($"D{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        2,
                        j
                    }, null));
                worksheet.get_Range($"E{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        3,
                        j
                    }, null));
                worksheet.get_Range($"F{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        4,
                        j
                    }, null));
                worksheet.get_Range($"G{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        5,
                        j
                    }, null));
                worksheet.get_Range($"H{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        6,
                        j
                    }, null));
                worksheet.get_Range($"I{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        7,
                        j
                    }, null));
                worksheet.get_Range($"J{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        8,
                        j
                    }, null));
                worksheet.get_Range($"K{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        9,
                        j
                    }, null));
                worksheet.get_Range($"L{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        10,
                        j
                    }, null));
                worksheet.get_Range($"M{Conversions.ToString(l)}", Missing.Value).set_Value(Missing.Value,
                    NewLateBinding.LateIndexGet(obj, new object[]
                    {
                        11,
                        j
            ...
            {
                worksheet.SaveAs(
                    $"{MySettingsProperty.Settings.WorkDir}\\{MySettingsProperty.Settings.Draw} - Перечень деталей.xls");
                bw.ReportProgress(0, $"{MySettingsProperty.Settings.Draw} - Перечень деталей.xls cоздан\r\n");
            }
            catch (Exception)
            {
                bw.ReportProgress(0,
                    $"Не получилось сохранить{MySettingsProperty.Settings.Draw} - Перечень деталей.xls!\r\n");
            }
            finally
            {
            ...
            for (j = num38; j <= num39; j++)
                if ((Strings.InStr(Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j], new object[]
                    {
                        8
                    }, null)), "CURVED") != 0) | (Strings.InStr(Conversions.ToString(NewLateBinding.LateIndexGet(
                        arrayList[j], new object[]
                        {
                            12
                        }, null)), "BENT") != 0) | (Strings.InStr(Conversions.ToString(NewLateBinding.LateIndexGet(
                        arrayList[j], new object[]
                        {
                            12
                        }, null)), "FOLDED") != 0) | (Strings.InStr(Conversions.ToString(NewLateBinding.LateIndexGet(
                        arrayList[j], new object[]
                        {
                            8
                        }, null)), "KNUCKLED") != 0))
            ...
            for (j = 2; j <= num - 1; j++)
                if (Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j], new object[]
                    {
                        8
                    }, null)).Contains("CURVED") || Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j],
                        new object[]
                        {
                            12
                        }, null)).Contains("BENT") || Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j],
                        new object[]
                        {
                            12
                        }, null)).Contains("FOLDED") || Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j],
                        new object[]
                        {
                            8
                        }, null)).Contains("KNUCKLED"))
                {
                    ...
                    {
                        var num42 = Strings.InStr(Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j],
                            new object[]
                            {
                                22
                            }, null)), ".");
                        string text3;
                        if ((num42 != 0) & (Conversions.ToInteger(Strings.Mid(Conversions.ToString(
                                NewLateBinding.LateIndexGet(arrayList[j], new object[]
                                {
                                    22
                                }, null)), num42 + 1, 1)) > 0))
                            text3 = Strings.Left(Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j],
                                new object[]
                                {
                                    22
                                }, null)), num42 + 1);
                        ...
                        num42 = Strings.InStr(Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j],
                            new object[]
                            {
                                20
                            }, null)), ".");
                        string text4;
                        if (num42 != 0)
                            text4 = Strings.Left(Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j],
                                new object[]
                                {
                                    20
                                }, null)), num42 - 1);
                        ...
                        string text5;
                        if (num42 != 0)
                            text5 = Strings.Left(Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j],
                                new object[]
                                {
                                    21
                                }, null)), num42 - 1);
                        ...
                        NewLateBinding.LateIndexSet(obj4, new object[]
                        {
                            l,
                            5,
                            string.Concat(text3, " x ", text4, " x ", text5)
                        }, null);
                    }
                             ...
                             }, null)), "PROFILE") != 0)
                    {
                        ...
                        else
                        {
                            ...
                            var text4 = Strings.Right(Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j],
                                new object[]
                                {
                                    24
                            ...
                            var text5 = Strings.Left(Conversions.ToString(NewLateBinding.LateIndexGet(arrayList[j],
                                new object[]
                                {
                                    24
                                }, null)), num42 - 1);
                            ...
                            NewLateBinding.LateIndexSet(obj4, new object[]
                            {
                                l,
                                5,
                                string.Concat(text4, " x ", text5, " x ", text3)
                            }, null);
                        }
                    }
                ...
                for (l = num46; l <= num47; l++)
                {
                    ...
                    if (Conversions.ToBoolean(Operators.AndObject(Operators.CompareObjectEqual(
                            ...
                            }, null), NewLateBinding.LateIndexGet(obj4, new object[]
                            {
                                l,
                                2
                            }, null), false), Operators.CompareObjectEqual(NewLateBinding.LateIndexGet(obj4,
                            new object[]
                            {
                                j,
                                5
                        ...
                        }, null), false))))
                    {
                        ...
                        if (Conversions.ToBoolean(Operators.AndObject(Strings.InStr(Conversions.ToString(
                                NewLateBinding.LateIndexGet(obj4, new object[]
                                {
                                    num43,
                                    6
                                }, null)), Conversions.ToString(NewLateBinding.LateIndexGet(obj4, new object[]
                            {
                                j,
                                6
                            }, null))) == 0, Operators.CompareObjectNotEqual(NewLateBinding.LateIndexGet(obj4,
                                new object[]
                                {
                                    num43,
                                    6
                            ...
                            NewLateBinding.LateIndexSet(obj4, new[]
                            {
                                num43,
                                6,
                                Operators.ConcatenateObject(Operators.ConcatenateObject(NewLateBinding.LateIndexGet(
                                    obj4, new object[]
                                    {
                                        num43,
                                        6
            ...
            for (j = num56; j <= num57; j++) array9[j, 0] = j + 1;
            int num58;
            ...
            workbook = application.Workbooks.Open($"{System.Windows.Forms.Application.StartupPath}\\VED_GIB2.xls",
                Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value,
                Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value, Missing.Value,
                Missing.Value);
            if (num58 > 1)
            {
                ...
                {
                    NewLateBinding.LateCall(workbook.Sheets[$"Лист{Conversions.ToString(j - 1)}"], null, "Copy",
                        new object[]
                        {
                            Missing.Value,
                            workbook.Sheets[$"Лист{Conversions.ToString(j - 1)}"]
                        }, null, null, null, true);
                    NewLateBinding.LateSetComplex(workbook.Sheets[$"Лист{Conversions.ToString(j - 1)} (2)"], null,
                        "name", new object[]
                        {
            ...
            {
                workbook.SaveAs(
                    $"{MySettingsProperty.Settings.WorkDir}\\{MySettingsProperty.Settings.Draw} - Ведомость гибки.xls");
                bw.ReportProgress(0, $"{MySettingsProperty.Settings.Draw} - Ведомость гибки.xls cоздана\r\n");
            }
            catch (Exception)
            {
                bw.ReportProgress(0,
                    $"Не получилось сохранить {MySettingsProperty.Settings.Draw} - Ведомость гибки.xls!\r\n");
            }
            finally
            {
                workbook.Close(false, Missing.Value, Missing.Value);
